...
export const AREAS = {
  wood: {
    ...
    npcs: [
      { idx: 1, name: 'WARDEN HESK', sheet: 'hesk', look: { hair: '#3a2a1a', skin: '#d9a978', tunic: '#5f7a3a', pants: '#4a4a55', boots: '#2a2a2a', accent: '#c9a227', hat: '#6a5a3a' },
      ...
      { idx: 2, name: 'MOTHER PELL', sheet: 'pell', look: { hair: '#6b3f22', skin: '#f2c9a0', tunic: '#8a4a5a', pants: '#8a4a5a', boots: '#3a2a1a', dress: true, accent: '#f7f2e6' },
